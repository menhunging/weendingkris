        ...
        <SectionReveal className="mx-auto w-full max-w-[600px] rounded-[2.5rem] border border-[#edd8de] bg-[#fffafb] p-6 shadow-[0_30px_100px_rgba(102,33,54,0.06)]">
          <div className="mx-auto max-w-[30rem]">
            ...
            >
              ...
              <br />
              <br />
              Формат нашего мероприятия не предполагает детской зоны и
              аниматоров. По возможности оставьте малышей в надежных руках на
              вечер нашего торжества и погрузитесь в атмосферу праздника вместе
              с нами.
            </p>
          </div>
        </SectionReveal>
      ...
      <section className="px-4 py-8" style={{ textAlign: "center" }}>
        <SectionReveal className="mx-auto w-full max-w-[600px] rounded-[2.5rem] border border-[#edd8de] bg-[#fffafb] p-6 shadow-[0_30px_100px_rgba(102,33,54,0.06)]">
          <div className="" style={{ textAlign: "center" }}>
            ...
            >
              Ваши улыбки — лучшее украшение, а ваши образы - важная часть
              красоты этого дня. 🤍
              <br />
              Мы будем признательны, если при выборе наряда вы отдадите
              предпочтение нежной пастельной гамме, классическому черному или
              спокойным тонам.
            </p>
          </div>
        </SectionReveal>
